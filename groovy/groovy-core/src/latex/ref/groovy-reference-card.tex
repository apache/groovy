...
\methodDetail{  obj. }{ allProperties}{()                         }{ obtain List of properties on {\em obj\/}}
...
\methodDetail{  obj. }{ eachProperty}{() \{closure\}             }{ apply {\em closure\/} to each property of {\em obj\/}}
\methodSummary{  obj. }{ eachPropertyName}{() \{closure\}         }{ apply {\em closure\/} to each property name of {\em obj\/}}
