...
public abstract class ParserPlugin {
    ...
    /**
     * Creates a new instance, using the New Groovy parser plugin if its available
     * otherwise default to the classic plugin
     *
     * @return
     */
    public static ParserPlugin newInstance() {
