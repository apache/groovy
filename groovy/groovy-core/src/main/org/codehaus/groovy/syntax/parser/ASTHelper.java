...
public class ASTHelper {
    ...
    protected SourceUnit  controller;    // The SourceUnit controlling us
    protected ClassLoader classLoader;   // Our ClassLoader, which provides information on external types
    protected Map         imports;       // Our imports, simple name => fully qualified name
