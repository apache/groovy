...
public abstract class NewMetaClass {
    ...
    private static final Class[] ONE_PARAMETER_TYPE =    new Class[1];
    private static final Class[] TWO_PARAMETER_TYPES =   new Class[2];
    private static final Class[] THREE_PARAMETER_TYPES = new Class[3];
    private static final Class[] FOUR_PARAMETER_TYPES =  new Class[4];
     ...
     * @param argumentTypes
     * This array must be the same length as the arguments array.
     * It contains the type of each parameter if known or null if unckown.
     * The if there are overloaded methods then this information contributes to the selection of the correct method to call.
     * The MetaClass may or may not change these values. DO NOT use these values after the call.
     * @return
     ...
     * @param argumentTypes
     * This array must be the same length as the arguments array.
     * It contains the type of each parameter if know or null if unckown.
     * The if there are overloaded methods then this information contributes to the selection of the correct method to call.
     * The MetaClass may or may not change these values. DO NOT use these values after the call.
     * @return
     * Either the result of calling the method (null is returned if the method returns void) or the value NOT_CALLED.
