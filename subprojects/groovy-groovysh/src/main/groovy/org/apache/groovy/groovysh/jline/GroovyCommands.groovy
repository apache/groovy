...
class GroovyCommands extends JlineCommandRegistry implements CommandRegistry {
    ...
    private CmdDesc nameCmdDesc(String name) {
        new CmdDesc([
            new AttributedString("$name [name]"),
        ], [], [
            '-? --help'     : doDescription('Displays command help'),
        ])
    }
...
/*
    Completer getCompleter() {
        ...
        org.apache.groovy.groovysh.util.PackageHelper packageHelper = shell.packageHelper
...
/*        Completer impCompleter = new StringsCompleter('/import ')
        Completer asCompleter = new StringsCompleter('as ')
        Completer nullCompleter = NullCompleter.INSTANCE
//        org.apache.groovy.groovysh.util.PackageHelper packageHelper = shell.packageHelper
//        Interpreter interp = shell.interp
        [
            new StricterArgumentCompleter([
                impCompleter,
                new ImportCompleter(packageHelper, interp, false),
                asCompleter,
                nullCompleter]),
...
/*
    static class ImportCompleter implements Completer {

        protected final Logger log = Logger.create(ImportCompleter)

        org.apache.groovy.groovysh.util.PackageHelper packageHelper
        //Groovysh shell
        ...
        ImportCompleter(final org.apache.groovy.groovysh.util.PackageHelper packageHelper, final Evaluator interp, final boolean staticImport) {
