...
found it a bit wierd using XML as a scripting language and wanted
...
[source,groovy]
----
include::{projectdir}/src/spec/test/builder/AntBuilderSpecTest.groovy[tags=example_echo,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/builder/AntBuilderSpecTest.groovy[tags=create_zip_builder,indent=0]
include::{projectdir}/src/spec/test/builder/AntBuilderSpecTest.groovy[tags=create_zip_zip,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/builder/AntBuilderSpecTest.groovy[tags=copy_files,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/builder/AntBuilderSpecTest.groovy[tags=filescanner,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/builder/AntBuilderSpecTest.groovy[tags=run_junit,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/builder/AntBuilderSpecTest.groovy[tags=compile_java,indent=0]
----

It is worth mentionning that `AntBuilder` is included in http://gradle.org/[Gradle], so you can use it in Gradle
