 ...
 * a template generated by {@link MarkupTemplateEngine#createTemplate(Reader)}.</p>
 *
...
public abstract class BaseTemplate implements Writable {
    ...
    /**
     * Escapes the string representation of the supplied object if it derives from {@link CharSequence},
     ...
     * {@link TemplateConfiguration#setNewLineString(String)}
     * @throws IOException
     */
     ...
     * instance</b>. This is less performant than using {@link #layout(Map, String)}.
     *
     ...
     * inheritance, see {@link #layout(Map, String, boolean)}.
     * @param model model to be passed to the template
