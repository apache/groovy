...
public class GeneratePropertyFromGetSet {
    ...
    public int setReturnTypeForSetters(String a)
    {

    }

    public int getReturnTypeForSetters()
    {

    }

    public void setParamForGetter(String a)
    {

    }

    public int getParamForGetter(String a)
    {
