...
final class JmxBeanExportFactoryTest {
    ...
    void testExplicitAttributesDeclaration() {
        ...
        beans = builder.export {
            bean(target: new MockManagedObject(), name: objName, attributes: '*')
        }
        ...
        beans = builder.export {
            bean(target: new MockManagedObject(), name: objName, attributes: ['Something', 'SomethingElse'])
        }
        gbean = beans[0]
        assert gbean.info().getAttribute('Something')
        assert gbean.info().getAttribute('SomethingElse')
        ...
        beans = builder.export {
            bean(target: new MockManagedObject(), name: objName, attributes: ['Something'])
        }
        gbean = beans[0]
        assert gbean.info().getAttribute('Something')
        assert !gbean.info().getAttribute('SomethingElse')
    ...
    void testExplicitConstructorDeclaration() {
        ...
        beans = builder.export {
            bean(target: new MockManagedObject(), name: objName, ctors: '*')
        }
        gbean = beans[0]
        assert gbean
        ...
        beans = builder.export {
            bean(target: new MockManagedObject(), name: objName, ctors: ['MockManagedObject': []])
        }
        gbean = beans[0]
        assert gbean
        ...
        beans = builder.export {
            bean(target: new MockManagedObject(), name: objName, ctors: ['MockManagedObject': ['String', 'int']])
        }
        gbean = beans[0]
        assert gbean
        assert gbean.info().getConstructors().size() == 1
