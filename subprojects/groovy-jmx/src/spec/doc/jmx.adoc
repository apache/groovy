...
image:{rootprojectdir}/subprojects/groovy-jmx/{specfolder}/assets/img/catalina.png[]
...
image:{rootprojectdir}/subprojects/groovy-jmx/{specfolder}/assets/img/oc4jpie.png[]
...
image:{rootprojectdir}/subprojects/groovy-jmx/{specfolder}/assets/img/jconsole.png[]
...
image:{rootprojectdir}/subprojects/groovy-jmx/{specfolder}/assets/img/jconsole-implicit-export.png[]
