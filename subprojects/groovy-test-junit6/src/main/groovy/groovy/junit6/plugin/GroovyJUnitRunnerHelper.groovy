...
class GroovyJUnitRunnerHelper {
    ...
    static Throwable execute(Class testClass) {
        ...
        println listener.summary.with{ "JUnit6 launcher: passed=$testsSucceededCount, aborted=$testsAbortedCount, failed=$testsFailedCount, skipped=$testsSkippedCount, time=${timeFinished-timeStarted}ms" }
