...
public class AstBuilder extends GroovyParserBaseVisitor<Object> implements GroovyParserVisitor<Object> {
    ...
    private void genSyntheticLambdaMethodNode(ClassNode classNode) {
        ...
        List<LambdaExpression> lambdaExpressionList = lambdaExpressionRegistry.get(classNode);
        ...
        for (LambdaExpression lambdaExpression : lambdaExpressionList) {
            String syntheticLambdaMethodNodeName = createSyntheticLambdaMethodNodeName();
            ...
            MethodNode methodNode =
                    classNode.addMethod(syntheticLambdaMethodNodeName, Opcodes.ACC_PRIVATE | Opcodes.ACC_STATIC | Opcodes.ACC_SYNTHETIC, ClassHelper.OBJECT_TYPE, parameters, ClassNode.EMPTY_ARRAY, lambdaExpression.getCode());

            lambdaExpression.putNodeMetaData(SYNTHETIC_LAMBDA_METHOD_NODE, methodNode);
            lambdaExpression.putNodeMetaData(LAMBDA_ENCLOSING_CLASSNODE, classNode);
...
//                    return this.configureAST(this.visitVariableDeclarator(e), ctx);
    ...
    public Tuple2<Token, Expression> visitIndexPropertyArgs(IndexPropertyArgsContext ctx) {
        ...
        return new Tuple2<>(ctx.LBRACK().getSymbol(), configureAST(listExpression, ctx));
    }
...
// } gstring       --------------------------------------------------------------------
    ...
    public LambdaExpression visitStandardLambdaExpression(StandardLambdaExpressionContext ctx) {
        LambdaExpression lambdaExpression = configureAST(this.createLambda(ctx.standardLambdaParameters(), ctx.lambdaBody()), ctx);
...
// } type       --------------------------------------------------------------------
    ...
    */
    ...
    private final Map<ClassNode, List<LambdaExpression>> lambdaExpressionRegistry = new LinkedHashMap<>();
    ...
    public static final String LAMBDA_ENCLOSING_CLASSNODE = "_LAMBDA_ENCLOSING_CLASSNODE";
    public static final String SYNTHETIC_LAMBDA_METHOD_NODE = "_SYNTHETIC_LAMBDA_METHOD_NODE";
}
