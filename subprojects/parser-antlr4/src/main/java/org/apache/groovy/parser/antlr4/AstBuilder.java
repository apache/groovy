...
public class AstBuilder extends GroovyParserBaseVisitor<Object> {
    ...
    @Deprecated
    public AstBuilder(final SourceUnit sourceUnit, final CompilerConfiguration compilerConfiguration) {
        this(sourceUnit, compilerConfiguration.isGroovydocEnabled(), compilerConfiguration.isRuntimeGroovydocEnabled());
    }
