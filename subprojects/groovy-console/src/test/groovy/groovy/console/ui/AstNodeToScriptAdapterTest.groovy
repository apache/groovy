...
final class AstNodeToScriptAdapterTest extends GroovyTestCase {
    ...
    void testGenericsInMethods() {
        ...
        assert result.contains('private java.util.List<Tree<? extends java.lang.Object<V>>> branches') // nested type args now rendered
        assert result.contains('branches = new java.util.ArrayList<Tree<? extends java.lang.Object<V>>>()') // nested type args now rendered
