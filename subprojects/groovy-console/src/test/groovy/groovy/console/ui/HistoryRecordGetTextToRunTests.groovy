...
class HistoryRecordGetTextToRunTests extends TestCase {
    ...
    void setUp() {
        ...
        // deprecated run(JApplet) method for backwards compatibility on the 4.0.x line;
        // later Groovy versions remove it (GROOVY-11912) and re-enable these tests.
    ...
    private def runSelected(String importText, String selectedText) {
        ...
        // a non-empty script name is required (was the JUnit3 TestCase name, which is
        // unavailable under the JUnit4 runner used to support conditional skipping)
