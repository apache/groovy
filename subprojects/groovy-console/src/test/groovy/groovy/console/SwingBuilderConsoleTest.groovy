...
class SwingBuilderConsoleTest extends GroovySwingTestCase {
    ...
    void setUp() {
        ...
        // on JDK 26+. Rather than break that API on the 4.0.x line, skip these tests there.
        // Later Groovy versions remove the method (GROOVY-11912) and re-enable the tests.
