...
/**
 * Disables the annotated test class or method if the Groovy closure evaluates to {@code true}.
 * <p>
 ...
 *   <li>{@code javaVersion} &mdash; Runtime Java feature version (e.g.&nbsp;17, 21)</li>
...
public @interface GroovyDisabledIf {
    Class value();
