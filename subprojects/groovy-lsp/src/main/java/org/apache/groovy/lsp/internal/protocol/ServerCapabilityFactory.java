...
public final class ServerCapabilityFactory {
    ...
    public ServerCapabilities create(final PositionEncoding encoding) {
        ...
        SemanticTokensWithRegistrationOptions tokens = new SemanticTokensWithRegistrationOptions(SemanticTokensService.legend());
        tokens.setFull(true);
        ...
        capabilities.setExecuteCommandProvider(new ExecuteCommandOptions(List.of(
                GroovyWorkspaceService.ORGANIZE_IMPORTS,
                GroovyWorkspaceService.SHOW_REFERENCES,
                GroovyWorkspaceService.GOTO_SUPER_METHOD)));
        return capabilities;
    }
}
