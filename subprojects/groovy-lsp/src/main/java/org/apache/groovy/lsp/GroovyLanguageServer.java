...
public final class GroovyLanguageServer implements LanguageServer, LanguageClientAware {
    ...
    private final LanguageFeatures features = new LanguageFeatures();
    ...
    public GroovyLanguageServer(final LanguageServerContext context) {
        ...
        this.textDocuments = new GroovyTextDocumentService(context, features);
        this.workspace = new GroovyWorkspaceService(context, features);
    }

    /**
     * @return feature services for this process
     */
    ...
    public CompletableFuture<InitializeResult> initialize(final InitializeParams params) {
        ...
        InitializeResult result = new InitializeResult(capabilities.create(context.getPositionEncoding()));
