...
import org.apache.groovy.lsp.internal.intelligence.StaticTypeCheckingPass
import org.apache.groovy.lsp.internal.feature.CallSites
import org.apache.groovy.lsp.internal.feature.LanguageFeatures
import org.apache.groovy.lsp.internal.feature.MethodBinding
...
final class HelperCoverageTest {
    ...
    void privateUtilityConstructors() {
        [Identifiers, PackageGuess, ClientFeatures, GroovyKeywords, Uris,
         AstQuery, Positions, StaticTypeCheckingPass, NameHumps, GroovydocMarkdown,
         CallSites, MethodBinding].each { Class type ->
