...
final class FeatureCoverageTest {
    ...
    void remainingNavigationAndSymbolHelpers() {
        ...
        assert MethodBinding.resolveProperty(prop) == null
        ...
        assert MethodBinding.staticCallMatches(stat, method)
        MethodBinding.receiverMatchesOwner(new VariableExpression('this'), 'Hello')
        MethodBinding.receiverMatchesOwner(new ClassExpression(ClassHelper.OBJECT_TYPE), 'java.lang.Object')
        MethodBinding.receiverMatchesOwner(null, 'Hello')
        ...
        assert identity.refersTo(local, null)
        fixture = new LspFixture()
