...
public class SimplePromise<T> implements Promise<T> {
     ...
     */
    public static <U> SimplePromise<U> completedPromise(U value) {
        return of(CompletableFuture.completedFuture(value));
    }

    /**
     * Returns a new Promise that is completed when all of the provided Promises
     ...
     * @return a new Promise that is completed when all of the provided Promises complete
     ...
     *
     * @param ps the Promises
     * @return a new Promise that is completed with the result or exception of any
