...
public class InitializerStrategy extends BuilderASTTransformation.AbstractBuilderStrategy {
    ...
    /**
     * Internal phantom type used to indicate that a property has been set. It is used in conjunction with the parameterized type helper class generated by the {@code InitializerStrategy}.
     */
    public static abstract class SET {
    }

    /**
     * Internal phantom type used to indicate that a property remains unset. It is used in conjunction with the parameterized type helper class generated by the {@code InitializerStrategy}.
     */
