 ...
 *                 false
 * </pre>
 * You can add the same annotation to the class itself aswell, but need to specify at least listener and event.
 * Then it autocreates a private variable called <name>List (starting lowerCase) and uses this to store the listeners.
 * If compatible variable named this way, it will be used instead.
