...
public class GroovyClassLoader extends URLClassLoader {
     ...
     * <p>
     * It is recommended, though not strictly enforced, that no use
     * should be made of this instance after this method is invoked.
     * Any classes that are already loaded are still accessible.
     *
     * @see #getClassCacheEntry(String)
     * @see #setClassCacheEntry(Class)
     * @see #removeClassCacheEntry(String)
