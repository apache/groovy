...
public class ObjectRange extends AbstractList implements Range {
    ...
    private void constructorHelper(Comparable from, Comparable to) {
        ...
        if (from.getClass() == to.getClass()) {
            ...
            Comparable tempfrom = normaliseCharAndSingleStringToInt(from);
            Comparable tempto = normaliseCharAndSingleStringToInt(to);
            if (tempfrom.getClass() != tempto.getClass()) {
                ...
                if ((tempfrom instanceof Number && !(tempto instanceof Number))
                    ...
                    throw new IllegalArgumentException("Incompatible Argument classes for ObjectRange " + from.getClass() + ", " + to.getClass());
                }
