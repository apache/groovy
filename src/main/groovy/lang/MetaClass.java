...
public abstract class MetaClass {
    ...
    */
    ...
    protected static Class[] wrap(Class[] classes) {
    ...
    * @return
    */
    protected static Object asPrimitiveArray(List list, Class parameterType) {
    ...
    */
    protected static Object[] asArray(Object arguments) {
           if (arguments == null) {
               return EMPTY_ARRAY;
           }
    ...
    protected static boolean accessibleToConstructor(final Class at, final Constructor constructor) {
    ...
    *         list
    */
    protected static boolean containsMatchingMethod(List list, MetaMethod method) {
    ...
    protected static String capitalize(String property) {
    ...
    * @return
    */
    protected static Class[] convertToTypeArray(Object[] args) {
           if (args == null)
               return null;
           int s = args.length;
    ...
    *         method name
    */
    protected static Object createListenerProxy(Class listenerType, final String listenerMethodName, final Closure closure) {
    ...
    protected static boolean isGenericSetMethod(MetaMethod method) {
           return (method.getName().equals("set"))
               && method.getParameterTypes().length == 2;
       }

    protected static void logMethodCall(Object object, String methodName, Object[] arguments) {
    ...
    private static boolean isVargsMethod(Class[] paramTypes, Object[] arguments) {
    ...
    protected static Object doMethodInvoke(Object object, MetaMethod method, Object[] argumentArray) {
    ...
    protected static Object doConstructorInvoke(Constructor constructor, Object[] argumentArray) {
    ...
    protected static boolean isValidMethod(Object method, Class[] arguments, boolean includeCoerce) {
    ...
    protected static int calculateParameterDistance(Class[] arguments, Class[] parameters) {
           int dist=0;
    ...
    */
    ...
    protected static Class[] getParameterTypes(Object methodOrConstructor) {
    ...
    */
    protected static Object chooseMostGeneralMethodWith1NullParam(List methods) {
    ...
    *         object (e.g. Object)
    */
    protected static Object chooseEmptyMethodParams(List methods) {
           for (Iterator iter = methods.iterator(); iter.hasNext();) {
               Object method = iter.next();
               Class[] paramTypes = getParameterTypes(method);
               int paramLength = paramTypes.length;
    ...
    protected abstract MetaMethod retrieveMethod(Object owner, String methodName, Object[] arguments);
    ...
    protected static final Logger log = Logger.getLogger(MetaClassImpl.class.getName());
