...
final class BindableTransformTest {
    ...
    private final GroovyShell shell = GroovyShell.withConfig {
        imports { star 'groovy.beans', 'groovy.transform' }
    }
    ...
    @Test
    void testOnField() {
        shouldFail shell, CompilationFailedException, '''
    ...
    void testBindableParent() {
        assertScript shell, '''import java.beans.*
            @Bindable
    ...
    void testPropertyChangeMethodsNotSynthetic() {
        ...
        def method = myBean.getMethod('addPropertyChangeListener', PropertyChangeListener)
