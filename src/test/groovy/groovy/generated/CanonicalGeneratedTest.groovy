...
final class CanonicalGeneratedTest extends AbstractGeneratedAstTestCase {

    @Test
    void testImplicit() {
        def implicitCanonical = parseClass '''
        ...
        '''
        assert !implicitCanonical.annotations
        assertConstructorIsAnnotated(implicitCanonical)
        assertConstructorIsAnnotated(implicitCanonical, String, int)
    ...
    void test_constructor_is_not_annotated() {
        def explicitCanonical = parseClass '''
            @groovy.transform.Canonical
            class ClassUnderTest {
                String name
                int age
        ...
        '''
        assert !explicitCanonical.annotations
        assertConstructorIsNotAnnotated(explicitCanonical, String, int)
