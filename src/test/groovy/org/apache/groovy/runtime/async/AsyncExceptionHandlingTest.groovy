 ...
 *   <li>{@code await Awaitable.all()}/{@code await Awaitable.any()} with mixed success/failure</li>
 *   <li>{@code await Awaitable.allSettled()} — JavaScript's {@code Promise.allSettled()}</li>
...
final class AsyncExceptionHandlingTest {
    ...
    // =========================================================================
    // 4. await Awaitable.all() with mixed success/failure
    // =========================================================================
    ...
    // =========================================================================
    // 5. await Awaitable.allSettled() — Promise.allSettled() equivalent
    // =========================================================================
    ...
    // =========================================================================
    // 17. await Awaitable.allSettled() with CompletableFuture mix
    // =========================================================================
    ...
    // ================================================================
    // Await Awaitable.all/any (async/await-level coverage)
    // ================================================================
