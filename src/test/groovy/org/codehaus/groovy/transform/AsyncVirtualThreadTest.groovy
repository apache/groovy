...
final class AsyncVirtualThreadTest {
    ...
    void testAsyncMethodRunsOnVirtualThread() {
        assertScript '''
            ...
            if (AsyncUtils.isVirtualThreadsAvailable()) {
    ...
    void testHighConcurrencyWithVirtualThreads() {
        assertScript '''
            ...
            if (AsyncUtils.isVirtualThreadsAvailable()) {
                ...
                def results = AsyncUtils.awaitAll(awaitables as Object[])
    ...
    void testAwaitAllWithMixedTypes() {
        assertScript '''
            ...
            def results = AsyncUtils.awaitAll(a1, a2, a3)
    ...
    void testAwaitAnyReturnsFirst() {
        assertScript '''
            ...
            def result = AsyncUtils.awaitAny(fast, slow)
            assert result == "fast"
        '''
    }
    ...
    void testAwaitAllSettledMixed() {
        assertScript '''
            ...
            def results = AsyncUtils.awaitAllSettled(success, failure)
