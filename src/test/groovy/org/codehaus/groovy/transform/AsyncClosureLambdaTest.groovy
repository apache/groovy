...
final class AsyncClosureLambdaTest {
    ...
    void testMultipleAsyncClosuresParallel() {
        assertScript '''
            ...
            def results = AsyncUtils.awaitAll(a(), b(), c())
    ...
    void testAwaitAllWithAsyncClosures() {
        assertScript '''
            ...
            def t2 = async { 2 }
            def t3 = async { 3 }
            def results = AsyncUtils.awaitAll(t1(), t2(), t3())
            assert results == [1, 2, 3]
        '''
    }
    ...
    void testAwaitAnyWithAsyncClosures() {
        assertScript '''
            ...
            def result = AsyncUtils.awaitAny(slowTask(), fastTask())
    ...
    void testAwaitAllSettledWithAsyncClosures() {
        assertScript '''
            ...
            def results = AsyncUtils.awaitAllSettled(ok(), fail())
    ...
    void testAsyncClosureInLoopBody() {
        assertScript '''
            ...
            def results = AsyncUtils.awaitAll(tasks as Object[])
