...
final class AsyncExceptionHandlingTest {
    ...
    void testAwaitAllWithFailureThrowsOriginal() {
        assertScript '''
            ...
            async caller() {
                try {
                    AsyncUtils.awaitAll(success(), failure())
                    assert false
                } catch (java.io.IOException e) {
                    return e.message
                }
    ...
    void testAwaitAllWithAwaitableObjects() {
        assertScript '''
            ...
            async caller() {
                def results = AsyncUtils.awaitAll(a(), b(), Awaitable.of(30))
                return results
            }
    ...
    void testAwaitAnyWithFailure() {
        assertScript '''
            ...
            async caller() {
                try {
                    AsyncUtils.awaitAny(Awaitable.failed(new java.io.IOException("fail")))
                    assert false
                } catch (java.io.IOException e) {
                    return e.message
                }
    ...
    void testAwaitAnyWithMixedSourceTypes() {
        assertScript '''
            ...
            async caller() {
                ...
                def result = AsyncUtils.awaitAny(cf, aw)
                return result
            }
    ...
    void testAwaitAllSettledAllSuccess() {
        assertScript '''
            ...
            async caller() {
                return AsyncUtils.awaitAllSettled(
    ...
    void testAwaitAllSettledGetOrElse() {
        assertScript '''
            ...
            async caller() {
                def results = AsyncUtils.awaitAllSettled(
                    Awaitable.of(10),
    ...
    void testAwaitAllSettledWithCompletableFutures() {
        assertScript '''
            ...
            async caller() {
                ...
                def results = AsyncUtils.awaitAllSettled(cf1, cf2)
