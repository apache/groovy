...
final class Groovy12093 {
    ...
    // This class covers the @Anchored-specific behaviour: that the marker
    // makes dispatch trait-anchored, the from-trait T.m() and external
    // Trait.m() resolution, the inInterface=false opt-out, per-callee
    // keying, @CompileStatic variants, the inInterface=false STC
    // compile-error case, and validation that @Anchored is rejected on
    // non-public-static targets.
