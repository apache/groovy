...
class TimeDatumDependentDurationJUnit5Test {
    ...
    void testConstructor() {
        TimeDatumDependentDuration duration = new TimeDatumDependentDuration(1, 2, 3, 4, 5, 6, 7);
    ...
    void testPlusDuration() {
        TimeDatumDependentDuration tddd = new TimeDatumDependentDuration(1, 2, 3, 4, 5, 6, 7);
    ...
    void testPlusDatumDependentDuration() {
        TimeDatumDependentDuration tddd1 = new TimeDatumDependentDuration(1, 2, 3, 4, 5, 6, 7);
        DatumDependentDuration ddd2 = new DatumDependentDuration(2, 3, 4, 5, 6, 7, 8);
    ...
    void testMinusDuration() {
        TimeDatumDependentDuration tddd = new TimeDatumDependentDuration(1, 2, 10, 10, 30, 45, 500);
    ...
    void testMinusDatumDependentDuration() {
        TimeDatumDependentDuration tddd1 = new TimeDatumDependentDuration(5, 6, 10, 10, 30, 45, 500);
        DatumDependentDuration ddd2 = new DatumDependentDuration(2, 3, 4, 5, 15, 20, 100);
    ...
    void testZeroDuration() {
        TimeDatumDependentDuration zero = new TimeDatumDependentDuration(0, 0, 0, 0, 0, 0, 0);
    ...
    void testNegativeDuration() {
        TimeDatumDependentDuration negative = new TimeDatumDependentDuration(-1, -2, -3, -4, -5, -6, -7);
    ...
    void testPlusTimeDatumDependentDuration() {
        TimeDatumDependentDuration tddd1 = new TimeDatumDependentDuration(1, 2, 3, 4, 5, 6, 7);
        TimeDatumDependentDuration tddd2 = new TimeDatumDependentDuration(1, 1, 1, 1, 1, 1, 1);
    ...
    void testMinusTimeDatumDependentDuration() {
        TimeDatumDependentDuration tddd1 = new TimeDatumDependentDuration(5, 6, 7, 8, 9, 10, 11);
        TimeDatumDependentDuration tddd2 = new TimeDatumDependentDuration(1, 2, 3, 4, 5, 6, 7);
