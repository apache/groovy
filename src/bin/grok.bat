...
set CLASSWORLDS_CONF=%GROOVY_HOME%\conf\grok-classworlds.conf
...
@rem Execute Groovy
"%JAVA_EXE%" %JAVA_OPTS% -classpath "%CLASSWORLDS_CLASSPATH%" %CLASSWORLDS_MAIN_CLASS% grok %CMD_LINE_ARGS%
