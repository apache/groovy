...
For those who want to test the very latest versions of Groovy and live on the bleeding edge,
you can use our https://groovy.jfrog.io/artifactory/libs-snapshot-local/org/codehaus/groovy[snapshot builds].
