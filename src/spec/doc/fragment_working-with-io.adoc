...
[source,groovy]
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=print_file_lines,indent=0]
----
...
[source,groovy]
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=print_file_lines2,indent=0]
----
...
[source,groovy]
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=withreader_exception,indent=0]
----
...
[source,groovy]
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=collect_lines,indent=0]
----
...
[source,groovy]
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=lines_as_strings,indent=0]
----
...
[source,groovy]
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=file_bytes,indent=0]
----
...
[source,groovy]
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=newinputstream,indent=0]
----
...
[source,groovy]
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=withinputstream,indent=0]
----
...
[source,groovy]
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=withwriter_example,indent=0]
----
...
[source,groovy]
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=file_leftshift,indent=0]
----
...
[source,groovy]
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=file_setbytes,indent=0]
----
...
[source,groovy]
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=newoutputstream,indent=0]
----
...
[source,groovy]
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=withoutputstream,indent=0]
----
...
[source,groovy]
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=eachfile,indent=0]
----
...
[source,groovy]
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=eachfilerecurse,indent=0]
----
...
[source,groovy]
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=traverse,indent=0]
----
...
[source,groovy]
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=data_in_out,indent=0]
----
...
[source,groovy]
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=object_in_out,indent=0]
----
...
[source,groovy]
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=process_list_files,indent=0]
----
...
[source,groovy]
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=process_list_files_line_by_line,indent=0]
----
<1> executes the `ls` command in an external process
...
[source,groovy]
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=dir_windows,indent=0]
----
...
[source,groovy]
----------------------------------
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=dir_windows_fixed,indent=0]
----------------------------------
...
[source,groovy]
----------------------------------
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=consumeoutput,indent=0]
----------------------------------
...
.Pipes in action
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=pipe_example_1,indent=0]
----

[source,groovy]
.Consuming errors
----
include::{includedir}/../test/gdk/WorkingWithIOSpecTest.groovy[tags=pipe_example_2,indent=0]
----
