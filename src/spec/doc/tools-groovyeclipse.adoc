...
The plugin section, change the compiler used by the
...
|4.4 |http://dist.springsource.org/release/GRECLIPSE/2.9.0/e4.4
|4.3 |http://dist.springsource.org/release/GRECLIPSE/2.9.0/e4.3
|4.3-j8 |http://dist.springsource.org/release/GRECLIPSE/2.9.0/e4.3-j8 (Includes the Java 8 Patch for Eclipse 4.3)
|4.2 |http://dist.springsource.org/release/GRECLIPSE/2.9.0/e4.2
|3.7 |http://dist.springsource.org/release/GRECLIPSE/2.9.0/e3.7 (untested, provided 'as is')
|=================================================================
