...
because there is _no_ static field _CALLED_ defined on the trait itself. Likewise, if you have to distinct implementing classes, each ones gets a distinct static field:
