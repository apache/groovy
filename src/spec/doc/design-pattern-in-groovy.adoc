...
include::design-pattern-abstract-factory.adoc[]

include::design-pattern-adapter.adoc[]

include::design-pattern-bouncer.adoc[]

include::design-pattern-chain-of-responsibility.adoc[]

include::design-pattern-composite.adoc[]

include::design-pattern-decorator.adoc[]

include::design-pattern-delegation.adoc[]

include::design-pattern-flyweight.adoc[]

include::design-pattern-iterator.adoc[]

include::design-pattern-loan-my-resource.adoc[]

include::design-pattern-null-object.adoc[]

include::design-pattern-pimp-my-library.adoc[]

include::design-pattern-proxy.adoc[]

include::design-pattern-singleton.adoc[]

include::design-pattern-state.adoc[]

include::design-pattern-strategy.adoc[]

include::design-pattern-template-method.adoc[]

include::design-pattern-visitor.adoc[]
...
. Brad Appleton (1999). http://www.cmcrossroads.com/bradapp/docs/pizza-inv.html[Pizza Inversion - a Pattern for Efficient Resource Consumption].
