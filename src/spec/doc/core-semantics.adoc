...
[[gpath_expressions]]
=== GPath expressions (MarcPaquette)
////
...
_*More precisely*_, the above GPath expression produces a list of String, each being the name of an existing method on `this` where that name ends with `Foo`.
