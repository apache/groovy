...
include::../../../subprojects/groovy-bsf/src/spec/doc/fragment_integrating-bsf.adoc[leveloffset=+1]

include::../../../subprojects/groovy-jsr223/src/spec/doc/fragment_integrating-jsr223.adoc[leveloffset=+1]
