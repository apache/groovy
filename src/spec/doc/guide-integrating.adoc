...
----
include::{projectdir}/src/spec/test-resources/reloading/source1.groovy[]
----
...
.ReloadingTest.groovy
----
include::{projectdir}/src/spec/test-resources/reloading/source2.groovy[]
----
...
.Depencency.groovy
----
include::{projectdir}/src/spec/test-resources/reloading/dependency1.groovy[]
----
...
.ReloadingTest.groovy
----
include::{projectdir}/src/spec/test-resources/reloading/source3.groovy[]
----
...
.Depencency.groovy
----
include::{projectdir}/src/spec/test-resources/reloading/dependency2.groovy[]
----
