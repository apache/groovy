...
include::fragment_working-with-io.adoc[leveloffset=+1]

include::fragment_working-with-collections.adoc[leveloffset=+1]

include::../../../subprojects/groovy-dateutil/src/spec/doc/fragment_working-with-dateutil-types.adoc[leveloffset=+1]

include::../../../subprojects/groovy-datetime/src/spec/doc/fragment_working-with-datetime-types.adoc[leveloffset=+1]
