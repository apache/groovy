...
[source,groovy]
----
include::{projectdir}/src/spec/test/ConfigSlurperTest.groovy[tags=arbitrary_types,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ConfigSlurperTest.groovy[tags=never_null,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ConfigSlurperTest.groovy[tags=escape_dot,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ConfigSlurperTest.groovy[tags=environments,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ConfigSlurperTest.groovy[tags=custom_environments,indent=0]
----
<1> Once the new block is registered `ConfigSlurper` can parse it.

For Java integration purposes the `toProperies` method can be used to convert the `ConfigObject` to a `java.util.Properties`
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ConfigSlurperTest.groovy[tags=properties,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ExpandoTest.groovy[tags=expando_property,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ExpandoTest.groovy[tags=expando_method,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ObservableTest.groovy[tags=observable_list,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ObservableTest.groovy[tags=observable_list_clear,indent=0]
----
