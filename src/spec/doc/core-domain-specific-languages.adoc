...
[source,groovy]
---------------------------------------------------------------------------------------------------------------
include::../test/CommandChainsTest.groovy[tags=commandchain_1,indent=0]

include::../test/CommandChainsTest.groovy[tags=commandchain_2,indent=0]

include::../test/CommandChainsTest.groovy[tags=commandchain_3,indent=0]

include::../test/CommandChainsTest.groovy[tags=commandchain_4,indent=0]

include::../test/CommandChainsTest.groovy[tags=commandchain_5,indent=0]
---------------------------------------------------------------------------------------------------------------
...
[source,groovy]
-------------------------------------------------------------------------------------------------
include::../test/CommandChainsTest.groovy[tags=commandchain_6,indent=0]
-------------------------------------------------------------------------------------------------
...
[source,groovy]
-------------------------------------------------------------------------------------
include::../test/CommandChainsTest.groovy[tags=commandchain_7,indent=0]
-------------------------------------------------------------------------------------
...
[source,groovy]
------------------------------------------------------------------------------------------------------
include::../test/CommandChainsTest.groovy[tags=commandchain_impl1,indent=0]
------------------------------------------------------------------------------------------------------
...
[source,groovy]
----------------------------------------------------------------------------------------------------------------
include::../test/CommandChainsTest.groovy[tags=commandchain_impl2,indent=0]
include::../test/CommandChainsTest.groovy[tags=commandchain_impl2_assert,indent=0]
----------------------------------------------------------------------------------------------------------------
...
[source,groovy]
------------------------------------------------------------------------------------------------------
include::../test/CommandChainsTest.groovy[tags=commandchain_impl3,indent=0]
------------------------------------------------------------------------------------------------------
...
[source,groovy]
-----------------------------------------------------
include::../test/CommandChainsTest.groovy[tags=commandchain_impl3_assert,indent=0]
-----------------------------------------------------
...
[source,groovy]
----
include::../test/BaseScriptSpecTest.groovy[tags=simple_script,indent=0]
----
...
[source,groovy]
----
include::../test/BaseScriptSpecTest.groovy[tags=integ_binding,indent=0]
----
...
[source,groovy]
----
include::../test/BaseScriptSpecTest.groovy[tags=baseclass_def,indent=0]
----
...
[source,groovy]
----
include::../test/BaseScriptSpecTest.groovy[tags=use_custom_conf,indent=0]
----
...
[source,groovy]
----
include::../test/BaseScriptSpecTest.groovy[tags=use_basescript,indent=0]
----
...
[source,groovy]
----
include::../test/BaseScriptSpecTest.groovy[tags=use_basescript_alt,indent=0]
----
...
[source,groovy]
----
include::../test/BaseScriptSpecTest.groovy[tags=jep445_example,indent=0]
----
...
[source,groovy]
----
include::../test/BaseScriptSpecTest.groovy[tags=custom_run_method,indent=0]
----
...
[source,groovy]
----
include::../test/BaseScriptSpecTest.groovy[tags=custom_run_eval,indent=0]
----
...
[source,groovy]
----
include::../test/BaseScriptSpecTest.groovy[tags=custom_run_parse,indent=0]
----
...
[source,groovy]
---------------------------------------
include::../test/DelegatesToSpecTest.groovy[tags=email_builder_usage,indent=0]
---------------------------------------
...
[source,groovy]
----------------------------------------------
include::../test/DelegatesToSpecTest.groovy[tags=email_method_no_delegatesto,indent=0]
----------------------------------------------
...
[source,groovy]
----------------------------------------------
include::../test/DelegatesToSpecTest.groovy[tags=emailspec_no_delegatesto,indent=0]
----------------------------------------------
...
[source,groovy]
---------------------------------------
include::../test/DelegatesToSpecTest.groovy[tags=sendmail_typechecked_nodelegatesto,indent=0]
---------------------------------------
...
[source,groovy]
---------------------------------------
include::../test/DelegatesToSpecTest.groovy[tags=email_method_delegatesto,indent=0]
---------------------------------------
...
[source,groovy]
---------------------------------------
include::../test/DelegatesToSpecTest.groovy[tags=email_method_delegatesto_strategy,indent=0]
---------------------------------------
...
[source,groovy]
---------------------------------------
include::../test/DelegatesToSpecTest.groovy[tags=sendmail_typechecked_pass,indent=0]
---------------------------------------
...
[source,groovy]
-----------------------------------------------
include::../test/DelegatesToSpecTest.groovy[tags=simple_delegation,indent=0]
-----------------------------------------------
...
[source,groovy]
----------------------------------------------------------------------------------
include::../test/DelegatesToSpecTest.groovy[tags=delegation_with_strategy,indent=0]
----------------------------------------------------------------------------------
...
[source,groovy]
-------------------------------------------------
include::../test/DelegatesToSpecTest.groovy[tags=exec_method_no_delegatesto,indent=0]
-------------------------------------------------
...
[source,groovy]
-----------------------
include::../test/DelegatesToSpecTest.groovy[tags=exec_usage,indent=0]
-----------------------
...
[source,groovy]
---------------------------------------------------------------
include::../test/DelegatesToSpecTest.groovy[tags=exec_method_with_delegatesto,indent=0]
---------------------------------------------------------------
...
[source,groovy]
--------------------------------------
include::../test/DelegatesToSpecTest.groovy[tags=delegatesto_flow_typing_header,indent=0]
include::../test/DelegatesToSpecTest.groovy[tags=delegatesto_flow_typing_footer,indent=0]
--------------------------------------
...
[source,groovy]
--------------------------------------------------------------------
include::../test/DelegatesToSpecTest.groovy[tags=foobarbaz_method_no_delegatesto,indent=0]
--------------------------------------------------------------------
...
[source,groovy]
--------------------------------------------------------------------
include::../test/DelegatesToSpecTest.groovy[tags=foobarbaz_classes,indent=0]

include::../test/DelegatesToSpecTest.groovy[tags=foobarbaz_method_header,indent=0]
   ...
include::../test/DelegatesToSpecTest.groovy[tags=foobarbaz_method_footer,indent=0]
--------------------------------------------------------------------
...
[source,groovy]
-----------------------------------------------------------------------------
include::../test/DelegatesToSpecTest.groovy[tags=foobarbaz_multitarget,indent=0]

include::../test/DelegatesToSpecTest.groovy[tags=multitarget_test,indent=0]
-----------------------------------------------------------------------------
...
[source,groovy]
----
include::../test/DelegatesToSpecTest.groovy[tags=configure_list_method,indent=0]
----
...
[source,groovy]
----
include::../test/DelegatesToSpecTest.groovy[tags=configure_list_usage,indent=0]
----
...
[source,groovy]
----
include::../test/DelegatesToSpecTest.groovy[tags=configure_list_with_delegatesto,indent=0]
----
...
[source,groovy]
----
include::../test/DelegatesToSpecTest.groovy[tags=delegatestotype_mapper,indent=0]
----
...
[source,groovy]
----
include::../test/DelegatesToSpecTest.groovy[tags=delegatestotype_mapper_test,indent=0]
----
...
[source,groovy]
----
include::../test/DelegatesToSpecTest.groovy[tags=delegatestotype_mapper_fixed,indent=0]
----
...
include::../test/CustomizersTest.groovy[tags=import_cz,indent=0]
-----------------------------------------------------------------------------------------------------
...
include::../test/CustomizersTest.groovy[tags=ast_cz_simple,indent=0]
--------------------------------------------------------------------------
...
[source,groovy]
-----------------------------------------------------------------------------------------------------------------
include::../test/CustomizersTest.groovy[tags=ast_cz_customname,indent=0]
-----------------------------------------------------------------------------------------------------------------
...
[source,groovy]
--------------------------------------------------------------------------------------------------------------
include::../../../subprojects/groovy-astbuilder/src/spec/test/CustomizersTest.groovy[tags=ast_cz_closure,indent=0]
--------------------------------------------------------------------------------------------------------------
...
CAUTION: Despite its name, this customizer is *not* a sandbox and *not* a security
boundary. It secures the *grammar* not the *execution* - it is a best-effort restriction of the grammar available to a DSL, and nothing
more. It cannot constrain what otherwise-permitted code does at runtime, its coverage of
the source is deliberately partial (see <<secure-ast-limitations,Limitations>> below), and
an author of the source being compiled can work around it. The Apache Groovy
https://github.com/apache/groovy/blob/master/THREAT_MODEL.md[threat model] treats it as a
hardening aid rather than a security boundary: a demonstrated bypass is expected
behaviour, not a vulnerability. If you must run partially-trusted scripts, layer real
isolation *outside* the language — a separate process or JVM, an OS or container sandbox,
least-privilege credentials, and network egress controls — and treat this customizer as
one layer within that, never the perimeter.
...
include::../test/CustomizersTest.groovy[tags=secure_cz,indent=0]
-------------------------------------------------------------------------------------
...
[source,groovy]
----------------------------------------------------------------------
include::../test/CustomizersTest.groovy[tags=secure_cz_custom,indent=0]
----------------------------------------------------------------------
...
include::../test/CustomizersTest.groovy[tags=secure_cz_custom_assert,indent=4]
'''
----
...
[[secure-ast-limitations]]
==== Limitations of the secure AST customizer

Coverage is partial by design, so it is worth knowing where the checks do and do not
reach. The customizer visits the script statement block, method and constructor bodies,
static and instance initializer blocks, and field initializer expressions. It does *not*
visit the following, so restrictions such as `disallowedReceivers`, the statement and
expression allow/disallow lists, and your own custom checkers do not apply to code
appearing there:

* annotation members, including closure arguments to annotations
* code carrying no source position, which is how constructors, initializers and fields
  added by the compiler or by an AST transformation are told apart from those written by
  the author of the source being secured — a script class always has generated
  constructors, for example, and checking those would reject valid programs

A generated member may still *contain* code you wrote, because a transformation can move it
there: `@TupleConstructor(pre=...)` and `@MapConstructor(pre=...)` relocate the supplied
closure body into the constructor they generate, and `@ConditionalInterrupt` relocates its
condition into a synthetic method. Such code keeps its original source position and is
checked wherever it was moved to.

Note that a constructor is not a ``method definition'' as far as `methodDefinitionAllowed`
is concerned: its body is checked, but declaring one remains permitted.
...
`indirectImportCheckEnabled` flag exists to catch some of those, but only within the code
the customizer visits.
...
`@groovy.transform.ASTTest`, `@Grab` dependency resolution and static initializers all run
during compilation, before and independently of any customizer you configure. Restricting
the grammar of source that you nevertheless compile does not change this. When compiling
source you do not fully trust, you should also set the `groovy.grape.enable` system
property to `false`, keep the compile classpath under your control, and apply the
out-of-language isolation described above.
...
include::../test/CustomizersTest.groovy[tags=source_cz,indent=0]
--------------------------------------------------------------------
...
[source,groovy]
--------------------------------------------------------------------------
include::../test/CustomizersTest.groovy[tags=source_cz_predicates,indent=0]
--------------------------------------------------------------------------
...
include::../test/CustomizersTest.groovy[tags=customizer_withconfig,indent=0]
-----------------------------------------------------------------------------------------------------
...
include::../../../subprojects/groovy-xml/src/spec/doc/_sax-builder.adoc[leveloffset=+3]

include::../../../subprojects/groovy-xml/src/spec/doc/_stax-builder.adoc[leveloffset=+3]

include::../../../subprojects/groovy-xml/src/spec/doc/_dom-builder.adoc[leveloffset=+3]
...
[source,groovy]
----
include::../test/builder/NodeBuilderTest.groovy[tags=node_builder_gpath_assert,indent=0]
----

include::../../../subprojects/groovy-json/src/spec/doc/_json-builder.adoc[leveloffset=+3]

include::../../../subprojects/groovy-json/src/spec/doc/_streaming-jason-builder.adoc[leveloffset=+3]

include::../../../subprojects/groovy-swing/src/spec/doc/_swing-builder.adoc[leveloffset=+3]

include::../../../subprojects/groovy-ant/src/spec/doc/_ant-builder.adoc[leveloffset=+3]
...
| args           | the number of argument values | `int` or `String` {nbsp} {nbsp} (1)
...
| valueSeparator | the character that is the value separator | `char` {nbsp} {nbsp} (2)
| defaultValue   | a default value | `String`
| convert        | converts the incoming String to the required type | `Closure` {nbsp} {nbsp} (1)
|======================
...
[source,groovy]
----
include::../../testFixtures/groovy/cli/GreeterI.groovy[tags=annotationInterfaceSpec,indent=0]
----
...
[source,groovy]
----
include::../../testFixtures/groovy/cli/CliBuilderTestCase.groovy[tags=annotationInterface,indent=0]
----
...
[source,groovy]
----
include::../../testFixtures/groovy/cli/GreeterC.groovy[tags=annotationClassSpec,indent=0]
----
...
[source,groovy]
----
include::../../testFixtures/groovy/cli/CliBuilderTestCase.groovy[tags=annotationClass,indent=0]
----
...
[source,groovy]
----
include::../../testFixtures/groovy/cli/CliBuilderTestCase.groovy[tags=annotationScript,indent=0]
----
...
[source,groovy]
----
include::../../testFixtures/groovy/cli/CliBuilderTestCase.groovy[tags=withArgument,indent=0]
----
...
[source,groovy]
----
include::../../testFixtures/groovy/cli/WithArgsI.groovy[tags=withArgumentInterfaceSpec,indent=0]
----
...
[source,groovy]
----
include::../../testFixtures/groovy/cli/CliBuilderTestCase.groovy[tags=withArgumentInterface,indent=0]
----
...
[source,groovy]
----
include::../../testFixtures/groovy/cli/CliBuilderTestCase.groovy[tags=withType,indent=0]
----
...
[source,groovy]
----
include::../../testFixtures/groovy/cli/CliBuilderTestCase.groovy[tags=withConvert,indent=0]
----
...
[source,groovy]
----
include::../../testFixtures/groovy/cli/WithConvertI.groovy[tags=withConvertInterfaceSpec,indent=0]
----
...
[source,groovy]
----
include::../../testFixtures/groovy/cli/CliBuilderTestCase.groovy[tags=withConvertInterface,indent=0]
----
...
[source,groovy]
----
include::../../testFixtures/groovy/cli/CliBuilderTestCase.groovy[tags=multipleArgs,indent=0]
----
...
[source,groovy]
----
include::../../testFixtures/groovy/cli/ValSepI.groovy[tags=multipleArgsInterfaceSpec,indent=0]
----
...
[source,groovy]
----
include::../../testFixtures/groovy/cli/CliBuilderTestCase.groovy[tags=multipleArgsInterface,indent=0]
----
...
[source,groovy]
----
include::../../testFixtures/groovy/cli/CliBuilderTestCase.groovy[tags=withTypeMultiple,indent=0]
----
...
[source,groovy]
----
include::../../testFixtures/groovy/cli/CliBuilderTestCase.groovy[tags=withDefaultValue,indent=0]
----
...
[source,groovy]
----
include::../../testFixtures/groovy/cli/WithDefaultValueI.groovy[tags=withDefaultValueInterfaceSpec,indent=0]
----
...
[source,groovy]
----
include::../../testFixtures/groovy/cli/CliBuilderTestCase.groovy[tags=withDefaultValueInterface,indent=0]
----
...
[source,groovy]
----
include::../../testFixtures/groovy/cli/TypeCheckedI.groovy[tags=withTypeCheckedInterfaceSpec,indent=0]
----
...
[source,groovy]
----
include::../../testFixtures/groovy/cli/CliBuilderTestCase.groovy[tags=withTypeCheckedInterface,indent=0]
----
...
[source,groovy]
----
include::../../testFixtures/groovy/cli/CliBuilderTestCase.groovy[tags=withTypeChecked,indent=0]
----
...
[source,groovy]
----
include::../../../subprojects/groovy-cli-picocli/src/spec/test/builder/CliBuilderTest.groovy[tags=withUsageMessageSpec,indent=0]
----
Gives this output:
...
[source,groovy]
----
include::../../../subprojects/groovy-cli-picocli/src/spec/test/builder/CliBuilderTest.groovy[tags=mapOptionImports,indent=0]

include::../../../subprojects/groovy-cli-picocli/src/spec/test/builder/CliBuilderTest.groovy[tags=mapOption,indent=0]
----
...
[source,groovy]
----
include::../test/builder/ObjectGraphBuilderTest.groovy[tags=domain_classes,indent=0]
----
...
[source,groovy]
----
include::../test/builder/ObjectGraphBuilderTest.groovy[tags=builder_example,indent=0]
----
...
[source,groovy]
----
include::../test/builder/ObjectGraphBuilderTest.groovy[tags=immutable_class,indent=0]
----
...
[source,groovy]
----
include::../test/builder/ObjectGraphBuilderTest.groovy[tags=immutable_fail_runtime,indent=0]
----

It will fail at runtime with:

----
include::../test/builder/ObjectGraphBuilderTest.groovy[tags=expected_error_immutable,indent=0]
----
...
[source,groovy]
----
include::../test/builder/ObjectGraphBuilderTest.groovy[tags=newinstanceresolver,indent=0]
----
...
[source,groovy]
----
include::../test/builder/ObjectGraphBuilderTest.groovy[tags=test_id,indent=0]
----
...
[source,groovy]
----
include::../test/builder/FileTreeBuilderTest.groovy[tags=example,indent=0]
----
...
[source,groovy]
----
include::../test/builder/FileTreeBuilderTest.groovy[tags=example_assert,indent=0]
----
...
[source,groovy]
----
include::../test/builder/FileTreeBuilderTest.groovy[tags=shorthand_syntax,indent=0]
----
