...
reach. The customizer visits the script statement block and method bodies. It does *not*
...
* constructor bodies — note also that a constructor is not a ``method definition'' as far
  as `methodDefinitionAllowed` is concerned
