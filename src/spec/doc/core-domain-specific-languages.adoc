...
We use http://www.xmlunit.org[XMLUnit] to check that the builder produced the expected result:
...
Again we use http://www.xmlunit.org[XMLUnit] to check that the builder output matches the expected result:
