...
include::{projectdir}/subprojects/groovy-json/{specfolder}/json-builder.adoc[leveloffset=+2]

==== StreamingJsonBuilder (TBD)

include::{projectdir}/subprojects/groovy-swing/{specfolder}/swing-builder.adoc[leveloffset=+2]
