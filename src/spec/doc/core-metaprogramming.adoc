...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=tostring_import,indent=0]

include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=tostring_simple,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=tostring_simple_assert,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=tostring_example_includeNames,indent=0]
----
|excludes|Empty list|List of properties to exclude from toString|
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=tostring_example_excludes,indent=0]
----
|includes|Empty list|List of fields to include in toString|
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=tostring_example_includes,indent=0]
----
|includeSuper|False|Should superclass be included in toString|
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=tostring_example_includeSuper,indent=0]
----
|includeFields|False|Should fields be included in toString, in addition to properties|
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=tostring_example_includeFields,indent=0]
----
|ignoreNulls|False|Should properties/fields with null value be displayed|
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=tostring_example_ignoreNulls,indent=0]
----
|includePackage|False|Use fully qualified class name instead of simple name in toString|
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=tostring_example_includePackage,indent=0]
----
|cache|False|Cache the toString string. Should only be set to true if the class is immutable.|
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=tostring_example_cache,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=equalshashcode,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=equalshashcode_example_excludes,indent=0]
----
|includes|Empty list|List of fields to include in equals/hashCode|
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=equalshashcode_example_includes,indent=0]
----
|callSuper|False|Whether to include super in equals and hashCode calculations|
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=equalshashcode_example_super,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=tupleconstructor_simple,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=tupleconstructor_example_excludes,indent=0]
----
|includes|Empty list|List of fields to include in tuple constructor generation|
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=tupleconstructor_example_includes,indent=0]
----
|includeFields|False|Should fields be included in tuple constructor generation, in addition to properties|
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=tupleconstructor_example_includeFields,indent=0]
----
|includeProperties|True|Should properties be included in tuple constructor generation|
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=tupleconstructor_example_includeProperties,indent=0]
----
|includeSuperFields|False|Should fields from super classes be included in tuple constructor generation|
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=tupleconstructor_example_includeSuperFields,indent=0]
----
|includeSuperProperties|True|Should properties from super classes be included in tuple constructor generation|
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=tupleconstructor_example_includeSuperProperties,indent=0]
----
|callSuper|False|Should super properties be called within a call to the parent constructor rather than set as properties|
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=tupleconstructor_example_callSuper,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=canonical_simple,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=canonical_example_excludes,indent=0]
----
|includes|Empty list|List of fields to include in tuple constructor generation|
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=canonical_example_includes,indent=0]
----
|=======================================================================
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=inheritconstructors_simple,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=oldstyle_category,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=newstyle_category,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=indexedproperty_simple,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=lazy_simple,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=lazy_simple_generated,indent=0]
----
...
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=lazy_default,indent=0]
----

In that case, the generated code looks like the following:

----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=lazy_default_generated,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=newify_python,indent=0]
----
* or using the `Ruby` style:
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=newify_ruby,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=delegating_class,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=delegating_class_generated,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=delegation_assert,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=delegate_example_interfaces,indent=0]
----
|deprecated|false|If true, also delegates methods annotated with @Deprecated|
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=delegate_deprecated_header,indent=0]
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=delegate_deprecated_footer,indent=0]
----
|methodAnnotations|False|Whether to carry over annotations from the methods of the delegate to your delegating method.|
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=delegate_example_annotations,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=delegate_example_parameter_annotations,indent=0]
----
|excludes|Empty array|A list of methods to be excluded from delegation|
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=delegate_example_excludes_header,indent=0]
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=delegate_example_excludes_footer,indent=0]
----
|includes|Empty array|A list of methods to be included in delegation|
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=delegate_example_includes_header,indent=0]
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=delegate_example_includes_footer,indent=0]
----
|=======================================================================
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=immutable_simple,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=immutable_example_knownimmutableclasses,indent=0]
----
|knownImmutables|Empty list|A list of property names which are deemed immutable.|
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=immutable_example_knownimmutables,indent=0]
----
|=======================================================================
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=memoized_long_computation,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=memoized_long_computation_asserts,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=memoized_long_computation_cached,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=singleton_simple,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=singleton_example_property,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/ASTTransformsTest.groovy[tags=singleton_example_lazy,indent=0]
----
