...
==== ExpandoMetaClass (TBD)
===== Constructors (TBD)
===== Borrowing methods (TBD)
===== Dynamic method names (TBD)
===== GroovyObject methods (TBD)
===== Overriding static invokeMethod (TBD)
===== Properties (TBD)
===== Runtime discovery (TBD)
===== Static methods (TBD)

=== Extension modules (TBD)
==== Module descriptor (TBD)
==== Instance methods (TBD)
==== Static methods (TBD)
