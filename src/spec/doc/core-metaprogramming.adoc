...
wherever the transformation apply. Compiled classes that implement global tranasformations
...
The AST (Abstract Syntax Tree) is a tree structure constisting mostly of
...
----
<1> even if not mandatory, if you write an AST transformation in Groovy, it is highly recommanded to use `CompileStatic`
