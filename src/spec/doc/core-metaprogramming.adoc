...
[source,groovy]
----
include::../test/ASTTransformsTest.groovy[tags=immutable_simple,indent=0]
----
...
[source,groovy]
----
include::../test/ASTTransformsTest.groovy[tags=immutable_example_knownimmutableclasses,indent=0]
----
|knownImmutables|Empty list|A list of property names which are deemed immutable.|
[source,groovy]
----
include::../test/ASTTransformsTest.groovy[tags=immutable_example_knownimmutables,indent=0]
----
|=======================================================================
...
[source,groovy]
----
include::../test/ASTTransformsTest.groovy[tags=memoized_long_computation,indent=0]
----
...
[source,groovy]
----
include::../test/ASTTransformsTest.groovy[tags=memoized_long_computation_asserts,indent=0]
----
...
[source,groovy]
----
include::../test/ASTTransformsTest.groovy[tags=memoized_long_computation_cached,indent=0]
----
...
[source,groovy]
----
include::../test/ASTTransformsTest.groovy[tags=singleton_simple,indent=0]
----
...
[source,groovy]
----
include::../test/ASTTransformsTest.groovy[tags=singleton_example_property,indent=0]
----
...
[source,groovy]
----
include::../test/ASTTransformsTest.groovy[tags=singleton_example_lazy,indent=0]
----
