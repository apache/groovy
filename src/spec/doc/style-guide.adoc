...
You can use named parameters with the default constructor (first the constructor is called, then the setters are called in turn in the sequence in which they are specified in the map):
