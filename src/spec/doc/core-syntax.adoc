...
Maps associate keys to values, separating keys and values with columns, and each key/value pairs with commas, 
...
Here, we used numbers as keys, as numbers can unambiguously recognized as numbers,
