...
(rather than the otherwise common JavaBean convention of capitalized with a "get" prefix).
...
For a record with many fields, it can be useful to make a copy with one or more fields changes.
