...
Consider the following example (inspired by http://wiki.rubygarden.org/Ruby/page/show/NullObjectPattern[this]) where we want to calculate size, cumulative sum and cumulative product of all the values in a tree structure.
