...
[source,groovy]
----
include::{projectdir}/src/spec/test/PackageTest.groovy[tags=type_aliasing,indent=0]
----
...
----
++
import thirdparty.MathLib as OrigMultiplyTwo
class MultiplyTwo extends OrigMultiplyTwo {
	def multiplay(def value)
	{
		return value * 3 //corrected here
	}
}
...
>>>>>>> 5c89147... Added the documentation for Program structure. Added the test cases for the code snippet as well
