...
[source,groovy]
----
include::../test/DesignPatternsTest.groovy[tags=bouncer_null_check,indent=0]
----
...
[source,groovy]
----
include::../test/DesignPatternsTest.groovy[tags=bouncer_null_check_usage,indent=0]
----
...
[source,groovy]
----
include::../test/DesignPatternsTest.groovy[tags=bouncer_null_check_usage_groovy_way,indent=0]
----
...
[source,groovy]
----
include::../test/DesignPatternsTest.groovy[tags=bouncer_validation,indent=0]
----
...
[source,groovy]
----
include::../test/DesignPatternsTest.groovy[tags=bouncer_validation_usage,indent=0]
----
...
[source,groovy]
----
include::../test/DesignPatternsTest.groovy[tags=bouncer_validation_usage_groovy_way,indent=0]
----