...
:sponsors-bronze-img: https://opencollective.com/friends-of-groovy/tiers/bronze-sponsor.svg?width=890
:backers-monthly-img: https://opencollective.com/friends-of-groovy/tiers/backer.svg?width=890
:backers-all-img: https://opencollective.com/friends-of-groovy/backers.svg?width=890
...
Thank you to our sponsors(donating monthly):
