...
Builds run primarily on {github-ci}[GitHub Actions]; the workflows live under `.github/workflows`.
A TeamCity server, sponsored by https://www.jetbrains.com[JetBrains], also runs builds {groovy-ci}[here].
