...
:backers-img: https://opencollective.com/friends-of-groovy/backers.svg?width=890
:sponsors-img: https://opencollective.com/friends-of-groovy/sponsors.svg?width=890
...
image:{sponsors-img}[Friends of Groovy, link={opencollective-link}]

Thank you to all our backers:

image:{backers-img}[Friends of Groovy, link={opencollective-link}]
