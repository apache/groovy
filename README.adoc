...
:revdate: 18-11-2020
:build-icon: https://ci.groovy-lang.org/app/rest/builds/buildType:(id:Groovy30xTestAllJdk8)/statusIcon
:travis-build-icon: https://travis-ci.com/apache/groovy.svg?branch=GROOVY_3_0_X
