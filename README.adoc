...
:revdate: 18-11-2020
:build-icon: https://ci.groovy-lang.org/app/rest/builds/buildType:(id:Groovy25xCheckJdk11)/statusIcon
:travis-build-icon: https://travis-ci.com/apache/groovy.svg?branch=GROOVY_2_5_X
:noheader:
